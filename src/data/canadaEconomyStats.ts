...
export const economyWidgets: EconomyStatWidget[] = [
  {
    ...
    fullDescription: 'Total consumer credit balances reached approximately $2.52 trillion in Q2 2025, a 4.4% year-over-year increase. The average credit card balance per Canadian was estimated at $4,499 in Q1 2025. Approximately 1.4 million Canadians missed at least one credit payment in Q1 2025, a level not seen since 2009.'
  },
  {
    id: 'household-debt',
    ...
    fullDescription: 'Total household debt reached $2.56 trillion CAD in Q4 2024. Per capita household debt is approximately $61,538 CAD. Non-mortgage debt per consumer is $21,931 CAD, exceeding pre-pandemic levels. The debt-to-income ratio stands at 171.9% of gross income as of Q1 2025.'
  },
  {
    id: 'national-debt',
    title: 'National Debt',
    ...
    fullDescription: 'Federal net debt stands at $1,445 billion CAD as of November 2025, translating to $34,709 CAD per capita and $43,551 CAD per taxpayer. The debt-to-GDP ratio is 110.8% in 2024. Debt has been increasing since 2014 in both absolute and GDP percentage terms.'
  },
  {
    id: 'unemployment',
    title: 'Unemployment',
    ...
    fullDescription: 'Unemployment rate stands at 6.9% as of October 2025, down from 7.1% in September. Approximately 1.5 million people are unemployed out of a labor force of ~21.7 million. The number of unemployed increased by 276,000 (+22.2%) year-over-year in November 2024.'
  },
  {
    id: 'homelessness',
    title: 'Homelessness',
  ...
  },
  {
    ...
    fullDescription: '10 million Canadians (25.5% of population) are affected by food insecurity in 2024, including 2.5 million children. Severe food insecurity affects 2.6 million people. Provincial rates range from 13.8% (Quebec) to 30.9% (Alberta). Territorial rates are much higher: Nunavut 58.1%, NWT 22.2%.'
  },
  {
    ...
    fullDescription: 'Top 100 infrastructure projects total over $300 billion CAD in projected value. Federal spending plan allocates $115.2 billion over 5 years. Major programs include Build Communities Strong Fund ($51B over 10 years), Home Building Initiatives ($25B over 5 years), and Trade Diversification Corridors ($10B over 7 years).'
  },
  {
    id: 'public-wellbeing',
  ...
  },
  {
    ...
    fullDescription: 'Total imports reached approximately $607 billion CAD in 2024. Imports from the US account for $377.0 billion CAD (+0.9% from 2023), representing 62.2% of total imports. Consumer goods imports hit a record high of $56.9 billion, while energy imports totaled $39.0 billion.'
  },
  {
    id: 'exports',
    title: 'Exports',
    ...
    fullDescription: 'Total exports reached approximately $721 billion CAD in 2024. Exports to the US total $547.4 billion CAD (flat 0.0% growth), representing 75.9% of Canadian exports. Energy exports ($176.2 billion) form the largest category. Canada maintains a trade surplus of $14.8 billion overall.'
  },
  {
    id: 'foreign-aid',
    ...
    fullDescription: 'Official Development Assistance (ODA) is estimated at $8.5-9.0 billion CAD in 2024, up from $8.1 billion in 2023 (0.33% of GNI). Canada is committed to increasing ODA toward the 0.7% GNI target recommended by the UN. Major recipients include Ukraine, humanitarian crises, and climate adaptation projects.'
  },
  {
...
export function getChangeColor(percent: number, isNegativeGood: boolean = false): string {
